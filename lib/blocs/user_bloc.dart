...
class UserBloc extends BlocBase {
  ...
  List<Map<String, dynamic>> _filter(String search) {
    ...
    filteredUsers.retainWhere((user) => user['name'].toUpperCase().contains(search.toUpperCase()));
  ...
  void _subscribeToOrders(String uid) {
    _users[uid]['subscription'] = _db
      ...
      for (DocumentSnapshot d in orders.documents) {
        DocumentSnapshot order = await _db.collection('orders').document(d.documentID).get();
